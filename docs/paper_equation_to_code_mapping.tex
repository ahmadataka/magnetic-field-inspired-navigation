...
\hline
PD goal attraction & Closer, with tuned paper-mode gains & The paper-PD branch is still implemented inside a multi-mode controller rather than as a line-by-line isolated paper port, but the updated paper-PD gains now succeed across the current polygon benchmark set, including the non-convex U-shape case. \\
\hline
